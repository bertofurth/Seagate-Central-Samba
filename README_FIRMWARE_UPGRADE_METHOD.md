...
samba software. This will be called **cross** if the procedure in
...
If the root password has not already been set or if the FORCE_PW_CHANGE
environment variable was set then the root password will be
